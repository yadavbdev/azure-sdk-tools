...
namespace Microsoft.WindowsAzure.Commands.ExpressRoute
{
    ...
    [Cmdlet(VerbsCommon.New, "AzureDedicatedCircuitLinkAuthorizationLiveIds")]
    public class NewAzureDedicatedCircuitLinkAuthorizationLiveIdsCommand : ExpressRouteBaseCmdlet
    {
