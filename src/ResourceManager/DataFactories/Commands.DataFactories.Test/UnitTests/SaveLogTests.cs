...
{
    public class SaveLogTests : DataFactoryUnitTestBase
    {
        private SaveAzureDataFactoryLogCommand _cmdlet;
        ...
        public SaveLogTests()
        {
            ...
            this._cmdlet = new SaveAzureDataFactoryLogCommand()
            {
        ...
        [Fact]
        public void CanSaveDataFactoryLog()
        {
