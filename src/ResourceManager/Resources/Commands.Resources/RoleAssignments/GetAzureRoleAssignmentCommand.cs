...
namespace Microsoft.Azure.Commands.Resources
{
    ...
    public class GetAzureRoleAssignmentCommand : ResourcesBaseCmdlet
    {
        ...
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ParameterSetName = ParameterSet.SearchString,
            HelpMessage = "Role to assign the principals with.")]
        ...
        public override void ExecuteCmdlet()
        {
            FilterRoleAssignmentsOptions options = new FilterRoleAssignmentsOptions()
            {
                ...
                ResourceIdentifier = new ResourceIdentifier()
                {
                    ...
                    Subscription = string.IsNullOrEmpty(ResourceGroupName) ? null : CurrentSubscription.SubscriptionId
                }
            };
